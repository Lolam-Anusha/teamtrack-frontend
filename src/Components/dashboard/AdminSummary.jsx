...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaHourglassHalf, FaRupeeSign, FaTimesCircle, FaUsers } from "react-icons/fa";
...
const AdminSummary = () => {
    ...
    useEffect(() => {
        const fetchSummary = async () => {
            try{
                const summary = await axios.get('https://teamtrack-backend.vercel.app/api/dashboard/summary',{
                    headers:{
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <SummaryCard icon={<FaRupeeSign />} text="Monthly Salary" number={summary.totalSalary} color="bg-red-600" />
            </div>
