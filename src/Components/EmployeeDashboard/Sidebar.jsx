...
import {FaBuilding, FaCalendarAlt, FaCogs, FaRupeeSign, FaTachometerAlt, FaUsers} from "react-icons/fa"
    ...
    return (
        <div className="bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64">
            <div className="bg-teal-600 h-12 flex items-center justify-center">
                <img src={image1} alt="logo" width={50} height={50} className="rounded"/>
                <h3 className="text-2xl text-center font-pacific">Team Track</h3>
            </div>
            <div className="px-4">
